...
import { useApproveTicket } from "service/scenicTicket";
import { useApproveModal, useTicketListQueryKey } from "../util";
...
export const ApproveModal = () => {
  ...
  const { mutateAsync, isLoading: mutateLoading } = useApproveTicket(
