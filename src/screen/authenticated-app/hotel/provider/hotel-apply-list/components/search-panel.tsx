import type { ProviderHotelListSearchParams } from "types/providerHotel";
...
export interface SearchPanelProps {
  ...
  setParams: (params: Partial<ProviderHotelListSearchParams>) => void;
}

const defaultParmas: Partial<ProviderHotelListSearchParams> = {
  status: undefined,
};
