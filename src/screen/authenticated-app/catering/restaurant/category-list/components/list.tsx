...
import { useDeleteRestaurantCategory } from "service/restaurantCategory";
...
export const List = ({ error, params, setParams, ...restProps }: ListProps) => {
  const { open } = useRestaurantCategoryModal();
...
const More = ({ id }: { id: number }) => {
  const { startEdit } = useRestaurantCategoryModal();
  const { mutate: deleteRole } = useDeleteRestaurantCategory(
    useRestaurantCategoriesQueryKey()
  );
