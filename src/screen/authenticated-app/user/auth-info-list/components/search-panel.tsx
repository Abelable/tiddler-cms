...
import type { AuthInfoListSearchParams } from "types/authInfo";

export interface SearchPanelProps {
  statusOptions: Option[];
  params: Partial<AuthInfoListSearchParams>;
  setParams: (params: Partial<AuthInfoListSearchParams>) => void;
}

const defaultParmas: Partial<AuthInfoListSearchParams> = {
  status: undefined,
  name: "",
  mobile: "",
};
